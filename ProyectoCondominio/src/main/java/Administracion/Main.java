...
/*
    ...
    administrador.agregarCondominio("Condominio 1");   
    //REQ_MA_CU-ManejarCondominio_02
    administrador.agregarInmuebleComun(gym);

    administrador.agregarPropiedadPrivada (5);
    //REQ_MA_CU-RegResidente_01. 
    administrador.registrarResidente("julio.zambrano@chone.ec", "chonero1234", "Julio Zambrano", true);
